...
public class CrosstermJni {
    {
        try {
            NativeLoader.instance.load("crossterm-jvm");
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
//        var libraryPath = Path.of("/Users/oyvind/pr/tui-scala/.bleep/generated-resources/tui-scala@jvm213/native/arm64-darwin/libcrossterm.dylib");
