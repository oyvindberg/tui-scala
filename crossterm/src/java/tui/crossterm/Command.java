...
public sealed interface Command
  ...
  /// A command that enables the [kitty keyboard
  // protocol](https://sw.kovidgoyal.net/kitty/keyboard-protocol/), which adds extra information to
  ...
  ///
  /// See [`PushKeyboardEnhancementFlags`] and <https://sw.kovidgoyal.net/kitty/keyboard-protocol/>
  ...
  /// * Use [EnterAlternateScreen](./struct.EnterAlternateScreen.html) to enter the alternate
  // screen.
