...
public final class Launcher {
  ...
  static {
    EXAMPLES.put(
        ...
        jatatui.examples.advancedwidgetimpl.AdvancedWidgetImplExample::main);
    EXAMPLES.put(
        "calendar-explorer", jatatui.examples.calendarexplorer.CalendarExplorerExample::main);
    ...
    EXAMPLES.put(
        "constraint-explorer", jatatui.examples.constraintexplorer.ConstraintExplorerExample::main);
    ...
    EXAMPLES.put(
        ...
        jatatui.examples.widgetrefcontainer.WidgetRefContainerExample::main);
  }
